package co.com.qvision.stepdefinitions.registerTourist;

import com.co.qvision.tasks.register.OpenThePage;
import com.co.qvision.tasks.registerTourist.CreateTourist;
...
public class RegisterTouristStepdefinition {
    ...
    public void alejoWantToCreateAAccount() {
        ...
        Alejo.wasAbleTo(CreateTourist.on());
    }
